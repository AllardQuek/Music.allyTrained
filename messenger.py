    ...
    if greetings:
        ...
        if intent == 'Greetings':
            ...
            for song in result:
                ...
                text += item
                count += 1
        elif intent == 'getComposer' and response['entities']['Romantic_Composer:Pyotr_Ilyich_Tchaikovsky'][0]['name'] == 'Baroque_Composer':
        ...
        elif intent == 'getComposer' and response['entities']['Romantic_Composer:Richard_Wagner'][0]['name'] == 'Romantic_Composer':
