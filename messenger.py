...
def get_joke(respones, fb_id):
    ...
    sequence = ["Why couldn't the string quartet find their composer? He was Haydn.",
                ...
                "How do you fix a broken brass instrument? With a tuba [tube of] glue.", 
                ...
                "If you can't tell which note is better, call it a tie.",
                "Why is a piano so hard to open? Because the keys are on the inside.",
                "There's music coming from the printer. I think the paper is jamming.",
                ...
                "What do you get when you cross a sweet potato and a jazz musician? A yam [jam] session!",
                ...
                "What is the difference between a fish and a piano? You can’t tuna fish but you can tuna piano.",
